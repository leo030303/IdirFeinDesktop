/// Country codes for wifi setup sourced from https://github.com/lukes/ISO-3166-Countries-with-Regional-Codes/blob/master/slim-2/slim-2.csv?plain=1
// TODO need to make sure these are valid for wifi
pub const COUNTRY_CODES_FOR_WIFI_SETUP: [(&str, &str); 249] = [
    ("Afghanistan", "af"),
    ("Åland Islands", "ax"),
    ("Albania", "al"),
    ("Algeria", "dz"),
